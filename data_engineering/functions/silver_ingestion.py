...
def silver_data_ingestion(pdf_name, table_name, logger):
    ...
    unnecessary_pages = ast.literal_eval(config["PROCESSING"][table_name])["unnecessary_pages"]
    correct_header = ast.literal_eval(config["PROCESSING"][table_name])["correct_header"]
